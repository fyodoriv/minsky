...
class TestExtractPrUrlParity:
    ...
    def test_handles_ghe_style_hosts(self) -> None:
        ...
        # `github\.com`. Without this, every successful Example-host
    ...
    def test_handles_github_example_com(self) -> None:
        ...
        assert (
            extract_pr_url("Created PR: https://github.example.com/team/repo/pull/123")
            == "https://github.example.com/team/repo/pull/123"
        )
...
class TestCli:
    ...
    def test_cli_file_flag(self, tmp_path: Path) -> None:
        ...
        log.write_text(
            "Working...\nPR opened: https://github.example.com/team/repo/pull/42\nDone.\n"
        )
        result = self._run_cli("--stdout-file", str(log))
        assert result.returncode == 0, result.stderr
        assert result.stdout.strip() == "https://github.example.com/team/repo/pull/42"
