...
echo "Next steps:"
echo "  cd $HOST_DIR"
echo "  minsky --transform                # full 8h session: baseline + run + report"
echo "  minsky --transform --baseline-only # just snapshot the current state"
echo "  minsky --transform --report-only   # diff current vs the baseline you snapshotted"
