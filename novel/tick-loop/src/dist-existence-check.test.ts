...
describe("tick-loop package.json drift — no package-level prepare", () => {
  ...
  // The root `tsc -b --force` handles dep-order correctly via TS project refs;
  // package-level prepare is redundant and actively harmful. (Tried+reverted
  // in PRs #477, #525, #562 — always breaks fresh-clone-smoke CI.)
