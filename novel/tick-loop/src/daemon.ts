...
export function buildDaemonBrief(args: {
  ...
  return [
    ...
    "",
    "Operator directive 2026-05-05: per iteration, spend ≤30s identifying ONE measurable optimization and act on it. Eligible: Brief-shrinking, Cached-prompt extension, Skip-earlier gate, Log-line dedup, Round-trip elimination.",
    "",
