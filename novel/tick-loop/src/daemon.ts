...
export function buildDaemonBrief(args: {
  ...
  return [
    ...
    "- **Red** → fix the failures and re-run, up to 3 attempts total. The stack's stderr names the exact failing step; each failure is a daemon-side fix iteration, not an operator-side cleanup PR.",
