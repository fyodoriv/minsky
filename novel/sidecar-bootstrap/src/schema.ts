...
export interface RepoConfig {
  /**
   * Canonical owner/repo identifier — `example-org/example-capabilities`,
   ...
   * cuts e.g. `feat/proj-840-slash-command-labels` from `default_branch`.
   */
   ...
   * Examples: `PROJ-\\d+`, `[A-Z]+-\\d+`, `#\\d+`. The runner uses this for
