...
| 6 | Document is enormous (>10 MB) | resource exhaustion | `loud-crash-supervisor-restart` (Node OOMs; let-it-crash) | (deferred — covered when the parser is wired into a long-running consumer; integration test will impose a 1 MB cap) |
