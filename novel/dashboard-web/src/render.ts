  ...
  const detail =
    a.taskId !== ""
      ...
      : a.reason !== ""
        ? escapeHtml(a.reason)
        : "";
  return `<li class="activity-row"><span class="activity-index">#${a.index}</span><span class="${statusClass}">${status}</span><span class="activity-detail">${detail}</span></li>`;
}
