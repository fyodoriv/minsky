#!/usr/bin/env node
// <!-- scope: human-approved 2026-05-16 — operator request to auto-route agent-detected concerns into TASKS.md via a drainer (per example-service-api session 2026-05-16) -->
/**
 ...
 *
 * @otel example-service-api.scripts.drain-concerns
 */
