...
export function buildRefreshTaskBlock(input) {
  ...
  return [
    ...
    `  - **Success**: \`competitors.ts\`'s \`${competitorId}\` entry has \`asOf\` within the last 90 days; \`competitors/${competitorId}.md\` Scorecard readings table matches; \`pnpm --filter @minsky/competitive-benchmark test\` green; \`competitors/scorecard.md\` regenerated via \`node scripts/render-scorecard-md.mjs\` reflects the new reading.`,
