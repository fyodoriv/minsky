...
1. ``github\\.com`` is hard-coded — on Intuit machines, the agent's
   PR URLs look like ``https://github.intuit.com/team/repo/pull/42``
   which doesn't match. **Every successful Intuit-host iteration
