...
``gh auth status`` — on Example machines that defaults to
``github.example.com``. Any iteration whose host repo lives on
...
host directory would 401 silently on Example machines. This closes that
parity gap.
