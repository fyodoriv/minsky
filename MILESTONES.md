...
**M1 summary** (2026-05-26) — done: 5 (M1.4, M1.6, M1.10, M1.12, M1.13); substrate ✅ + runtime gap: 1 (M1.9); partial: 6 (M1.2, M1.3, M1.5, M1.7, M1.11, M1.14); blocked: 2 (M1.1, M1.8); not started: 0. The `bin/minsky milestone check` alignment gate reports 14/14 surfaces aligned — the table's status column reflects substantive feature completion which can lag the alignment gate.
